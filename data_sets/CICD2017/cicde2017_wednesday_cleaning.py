...
###############################
file_path = Path(r"C:\Users\Kaye\OneDrive\Documentos\CS406\data_sets\CICD2017\Wednesday-workingHours.pcap_ISCX.csv")
...
plt.ylabel("Count")
plt.tight_layout()
plt.savefig(saved_imgs / "class_distribution_wednesday.png")
plt.show()
...
if samp_colmns:
    ...
    plt.tight_layout()
    plt.savefig(saved_imgs / "feature_histograms_wednesday.png")
    plt.show()
...
if len(samp_colmns) > 1:
    ...
    plt.tight_layout()
    plt.savefig(saved_imgs / "correlation_matrix_wednesday.png")
    plt.show()
...
if num_colmns_no_label:
    ...
    plt.tight_layout()
    plt.savefig(saved_imgs / "boxplot_sample_feature_wednesday.png")
    plt.show()
...
cleaned_output_file = file_path.parent / "cicids2017_wednesday_cleaned.csv"
